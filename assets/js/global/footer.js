...
<div class="footer__icon_flexbox">
  <a href="https://www.facebook.com/toddcf.writer/" target="_blank"><img src="${window.globalControl.prependRoot('assets/img/icons/facebook/facebook-20.png')}" alt="Facebook Author Page" class="footer__icon"></a>
  <a href="https://www.amazon.com/Todd-Croak-Falen/e/B003A1UF3I/ref=sr_ntt_srch_lnk_1?qid=1499390370&sr=8-1" target="_blank"><img src="${window.globalControl.prependRoot('assets/img/icons/amazon/amazon_a_ding.png')}" alt="Amazon Author Page" class="footer__icon"></a>
  <a href="https://www.goodreads.com/toddcf" target="_blank"><img src="${window.globalControl.prependRoot('assets/img/icons/goodreads/goodreads.png')}" alt="Goodreads Author Page" class="footer__icon"></a>
</div>
</section>
...
<section class="footer__section">
  ...
  <p class="font_size_body footer_p">Website by <a href="https://tcf-web-development.com/" target="_blank" class="footer__text-link"> TCF Web Development</a></p>
  <p class="copyright font_size_body footer_p">Copyright &copy; 2008 ${(!!thisYear) ? `&ndash; ${thisYear} ` : ''}Todd Croak-Falen</p>
</section>`;
document.body.appendChild(footerEl);

// Old homepage condition:
/*else if (!!thisYear) {
const currentYearHTML = document.querySelector('.currentYear');
if (!!currentYearHTML) {
  currentYearHTML.innerHTML = `&ndash; ${thisYear} `;*/